...
<div style="width:750px; height:550px; padding:5px; text-align:center; border: 5px solid #787878; display: block;
  ...
  margin-right: auto;">
       ...
       <span style="font-size:25px"><i>This is to certify that<br/>
                                        ...
                                        <b>SOME BASIC ALGORITHMS,DS ALGORITHMS FOR BEGINNERS AND MODERN ALGORITHM DESIGN FOUNDATION</b> course.</i></span><br/>
       <br><br>
</div>
</div>
<br>
...
<br>
<br>
<button class="btn-primary" ><a href="feedback.php" style="color:black;">Proceed</a></button>
<br/><br/><br/><br/>
    <footer>
